/*
 * slang.h v2026.4 from https://github.com/shader-slang/slang
 * Used by SharpGen to generate the interop code.
 * Modifications:
 ...
 *  - the enum after typedef uint32_t SessionFlags has no name so was named Session
