...
// TODO: Add NativeLibraryLoader package (1.0.13 or up)
...
public unsafe class RenderDoc
{
    ...
    public uint GetNumCaptures() => _api.GetNumCaptures();

    public unsafe string GetCapture(uint index)
    {
        uint pathLength;
        ulong timeStamp;
        var ret = _api.GetCapture(index, null, &pathLength, &timeStamp);
    ...
    public void SetCaptureSavePath(string path)
    {
        ...
        _api.SetCaptureFilePathTemplate(utf8Bytes);
    }
