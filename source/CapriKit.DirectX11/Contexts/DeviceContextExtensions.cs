...
public static class DeviceContextExtensions
{
    ...
    /// </summary>    
    public static void Setup(this DeviceContext deviceContext, IInputLayout inputLayout, PrimitiveTopology primitiveTopology, IVertexShader vertexShader, RasterizerState rasterizerState, IPixelShader pixelShader, BlendState blendState, DepthStencilState depthStencilState)
    {
    ...
    /// </summary>    
    public static void SetupFullScreenTriangle(this DeviceContext deviceContext, IVertexShader vertexShader, RasterizerState cullNone, IPixelShader pixelShader, BlendState blendState, DepthStencilState depthStencilState)
    {
