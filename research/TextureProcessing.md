...
Use the (currently empty) C# project in C:\projects\csharp\CapriKit\source\CapriKit.SuperCompressed\ to your C# code wrapper in. If you need an extra project to deal with the C++ stuff feel free to create it. But ideally this is all we need.
